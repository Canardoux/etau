...
import 'package:etau/dummy.dart' // Stub implementation
...
class FromBufferEx extends StatefulWidget {
  const FromBufferEx({super.key});
  @override
  State<FromBufferEx> createState() => _FromBufferEx();
}
