...
// ----------------------------------------------------- This is the very simple example (the code itself) --------------------------------------------------------------------------
  ...
  void hitPlayButton() async {
    ...
    AudioWorkletNodeOptions opt = Tau().newAudioWorkletNodeOptions( channelCountMode: 'explicit');
...
//var params = streamNode.parameters;
    streamNode.port.onmessage = (Map<String,String> m){
      print(m['data']);
    };
    ...
    AudioParam? totoParam = streamNode.parameters.getProperty("toto");
    AudioParam? totoParam2 = parameters["toto"];
